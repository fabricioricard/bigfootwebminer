...
import (
	...
	"github.com/bigchain/bigchaind/bigchainwallet/rpc/legacyrpc"
...
func main() {
	version.SetUserAgentName("bigchainwallet")
...
// startChainRPC opens a RPC client connection to a bigchaind server for blockchain
