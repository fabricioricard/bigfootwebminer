...
type NotificationHandlers struct {
	...
	// result of a rescan request, due to how bigchaind may send various rescan
...
func (c *Client) handleNotification(ntfn *rawNotification) {
	...
	case btcjson.BtcdConnectedNtfnMethod:
		...
		if err != nil {
			log.Warnf("Received invalid bigchaind connected "+
				"notification: %v", err)
			return
		}
...
//
// NOTE: This is a bigchaind extension ported from github.com/decred/dcrrpcclient
...
// parseBtcdConnectedNtfnParams parses out the connection status of bigchaind
// and bigchainwallet from the parameters of a bigchaindconnected notification.
...
//
// NOTE: This is a bigchaind extension and requires a websocket connection.
