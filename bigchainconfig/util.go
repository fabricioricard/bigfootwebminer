...
// CreateDefaultConfigFile copies the file sample-bigchaind.conf to the given destination path,
...
func ReadUserPass(filePath string) ([]string, er.R) {
	...
	cookiePath := strings.ReplaceAll(filePath, "bigchaind.conf", ".cookie")
