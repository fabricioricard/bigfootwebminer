...
bigchainwallet will not drop transaction history by itself, as this is something that
...
```
$ cd $GOPATH/src/github.com/pkt-cash/bigchaind/bigchainwallet/cmd/dropwtxmgr
$ go get
```
...
```
$ dropwtxmgr
Database path: /home/username/.bigchainwallet/pkt/wallet.db
Drop all bigchainwallet transaction history? [y/N] y
...
```
$ dropwtxmgr --db ~/.bigchainwallet/testnet/wallet.db
Database path: /home/username/.bigchainwallet/pkttestnet/wallet.db
Drop all bigchainwallet transaction history? [y/N] y
Dropping wtxmgr namespace
```

After dropping transaction history, bigchainwallet may be restarted and a full rescan
