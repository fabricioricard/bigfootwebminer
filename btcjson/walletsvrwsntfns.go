...
const (
	...
	BtcdConnectedNtfnMethod = "bigchaindconnected"
...
// BtcdConnectedNtfn defines the bigchaindconnected JSON-RPC notification.
type BtcdConnectedNtfn struct {
	Connected bool
}

// NewBtcdConnectedNtfn returns a new instance which can be used to issue a
// bigchaindconnected JSON-RPC notification.
