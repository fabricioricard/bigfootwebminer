...
// TestBIP0009Mining ensures blocks built via bigchaind's CPU miner follow the rules
...
func TestBIP0009Mining(t *testing.T) {
	...
	// version since the bigchaind mining code will have recognized the test
