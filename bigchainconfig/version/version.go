...
var userAgentName = "unknown" // bigchaind, bigchainwallet, bigchainctl...
var appMajor uint = 0
var appMinor uint = 0
var appPatch uint = 0
...
func init() {
	...
	tag := "-custom"
	// bigchaind-v1.1.0-beta-19-gfa3ba767
	if _, err := fmt.Sscanf(appBuild, "bigchaind-v%d.%d.%d", &appMajor, &appMinor, &appPatch); err == nil {
		tag = ""
		custom = false
