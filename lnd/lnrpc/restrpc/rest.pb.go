...
func (x *RestEmptyResponse) Reset() {
	*x = RestEmptyResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *RestEmptyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RestEmptyResponse) ProtoMessage() {}

func (x *RestEmptyResponse) ProtoReflect() protoreflect.Message {
	mi := &file_restrpc_rest_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RestEmptyResponse.ProtoReflect.Descriptor instead.
...
var file_restrpc_rest_proto_rawDesc = []byte{
	...
	0x6c, 0x64, 0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x22, 0x13, 0x0a, 0x11, 0x52, 0x65,
	0x73, 0x74, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0xb6, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x74, 0x48, 0x65, 0x6c, 0x70, 0x52, 0x65, 0x73, 0x70,
	...
	,
}
...
var file_restrpc_rest_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_restrpc_rest_proto_goTypes = []interface{}{
	...
	(*RestEmptyResponse)(nil),      // 4: restrpc.RestEmptyResponse
	(*RestHelpResponse)(nil),       // 5: restrpc.RestHelpResponse
	nil,                            // 6: restrpc.RestCommandCategory.EndpointsEntry
	nil,                            // 7: restrpc.RestCommandCategory.SubcategoryEntry
	nil,                            // 8: restrpc.RestMasterHelpResponse.CategoryEntry
}
var file_restrpc_rest_proto_depIdxs = []int32{
	6, // 0: restrpc.RestCommandCategory.endpoints:type_name -> restrpc.RestCommandCategory.EndpointsEntry
	7, // 1: restrpc.RestCommandCategory.subcategory:type_name -> restrpc.RestCommandCategory.SubcategoryEntry
	8, // 2: restrpc.RestMasterHelpResponse.category:type_name -> restrpc.RestMasterHelpResponse.CategoryEntry
...
func file_restrpc_rest_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_restrpc_rest_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RestEmptyResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
