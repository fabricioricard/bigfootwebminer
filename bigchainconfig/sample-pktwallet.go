...
; The server and port used for bigchaind websocket connections.
; rpcconnect=localhost:18334

; File containing root certificates to authenticate a TLS connections with bigchaind
; cafile=~/.bigchainwallet/bigchaind.cert
...
; rpccert=~/.bigchainwallet/rpc.cert
; rpckey=~/.bigchainwallet/rpc.key
...
; Username and password to authenticate to bigchaind a RPC server and authenticate
; new client connections
; rpcuser=
; rpcpass=

; Alternative username and password for bigchaind.  If set, these will be used
; instead of the username and password set above for authentication to a
; bigchaind RPC server.
; bigchaindusername=
; bigchaindpassword=
