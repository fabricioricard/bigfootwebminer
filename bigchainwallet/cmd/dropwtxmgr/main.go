...
var datadir = btcutil.AppDataDir("bigchainwallet", false)
...
func mainInt() int {
	...
	for !opts.Force {
		fmt.Print("Drop all bigchainwallet transaction history? [y/N] ")
	...
	fmt.Println("Dropping bigchainwallet transaction history")
