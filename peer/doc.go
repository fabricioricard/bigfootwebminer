...
function which allows a bigchainlog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/bigchain/bigchaind/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
