...
func (x *CrashRequest) Reset() {
	*x = CrashRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_metaservice_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CrashRequest) Descriptor() ([]byte, []int) {
	return file_metaservice_proto_rawDescGZIP(), []int{6}
}
...
func (x *CrashResponse) Reset() {
	*x = CrashResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_metaservice_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CrashResponse) Descriptor() ([]byte, []int) {
	return file_metaservice_proto_rawDescGZIP(), []int{7}
}
...
var file_metaservice_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_metaservice_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_metaservice_proto_goTypes = []interface{}{
	...
	(*CrashRequest)(nil),           // 6: lnrpc.CrashRequest
	(*CrashResponse)(nil),          // 7: lnrpc.CrashResponse
	(*NeutrinoInfo)(nil),           // 8: lnrpc.NeutrinoInfo
	(*WalletInfo)(nil),             // 9: lnrpc.WalletInfo
	(*GetInfoResponse)(nil),        // 10: lnrpc.GetInfoResponse
}
var file_metaservice_proto_depIdxs = []int32{
	8,  // 0: lnrpc.GetInfo2Response.neutrino:type_name -> lnrpc.NeutrinoInfo
	9,  // 1: lnrpc.GetInfo2Response.wallet:type_name -> lnrpc.WalletInfo
	10, // 2: lnrpc.GetInfo2Response.lightning:type_name -> lnrpc.GetInfoResponse
	...
	6,  // 6: lnrpc.MetaService.ForceCrash:input_type -> lnrpc.CrashRequest
	1,  // 7: lnrpc.MetaService.GetInfo2:output_type -> lnrpc.GetInfo2Response
	3,  // 8: lnrpc.MetaService.ChangePassword:output_type -> lnrpc.ChangePasswordResponse
	5,  // 9: lnrpc.MetaService.CheckPassword:output_type -> lnrpc.CheckPasswordResponse
	7,  // 10: lnrpc.MetaService.ForceCrash:output_type -> lnrpc.CrashResponse
...
func file_metaservice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_metaservice_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_metaservice_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
