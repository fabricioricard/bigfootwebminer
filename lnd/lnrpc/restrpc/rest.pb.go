...
type WebSocketRequest struct {
	...
	Payload *Any `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"`
}
...
func (x *WebSocketRequest) GetPayload() *Any {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *WebSocketResponse) GetOk() *Any {
...
type WebSocketResponse_Ok struct {
	...
	Ok *Any `protobuf:"bytes,3,opt,name=ok,proto3,oneof"`
}
...
var file_restrpc_rest_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x72, 0x65, 0x73, 0x74, 0x72, 0x70, 0x63, 0x22, 0x36, 0x0a,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xef, 0x02, 0x0a, 0x13, 0x52, 0x65, 0x73, 0x74, 0x43, 0x6f,
	...
	0x65, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x21, 0x0a, 0x05, 0x45,
	...
	0x01, 0x28, 0x0d, 0x52, 0x08, 0x68, 0x74, 0x74, 0x70, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x24, 0x0a,
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x72,
	0x65, 0x73, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72,
	0x72, 0x6f, 0x72, 0x22, 0x75, 0x0a, 0x10, 0x57, 0x65, 0x62, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74,
	...
	0x49, 0x64, 0x12, 0x26, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x72, 0x65, 0x73, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x41, 0x6e,
	0x79, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xa9, 0x01, 0x0a, 0x11, 0x57,
	...
	0x08, 0x52, 0x07, 0x68, 0x61, 0x73, 0x4d, 0x6f, 0x72, 0x65, 0x12, 0x1e, 0x0a, 0x02, 0x6f, 0x6b,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x72, 0x65, 0x73, 0x74, 0x72, 0x70, 0x63,
...
var file_restrpc_rest_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_restrpc_rest_proto_goTypes = []interface{}{
	(*Any)(nil),                    // 0: restrpc.Any
	(*RestCommandCategory)(nil),    // 1: restrpc.RestCommandCategory
	(*RestMasterHelpResponse)(nil), // 2: restrpc.RestMasterHelpResponse
	(*Field)(nil),                  // 3: restrpc.Field
	(*Type)(nil),                   // 4: restrpc.Type
	(*RestHelpResponse)(nil),       // 5: restrpc.RestHelpResponse
	(*Error)(nil),                  // 6: restrpc.Error
	(*WebSocketError)(nil),         // 7: restrpc.WebSocketError
	(*WebSocketRequest)(nil),       // 8: restrpc.WebSocketRequest
	(*WebSocketResponse)(nil),      // 9: restrpc.WebSocketResponse
	nil,                            // 10: restrpc.RestCommandCategory.EndpointsEntry
	nil,                            // 11: restrpc.RestCommandCategory.SubcategoryEntry
	nil,                            // 12: restrpc.RestMasterHelpResponse.CategoryEntry
}
var file_restrpc_rest_proto_depIdxs = []int32{
	10, // 0: restrpc.RestCommandCategory.endpoints:type_name -> restrpc.RestCommandCategory.EndpointsEntry
	11, // 1: restrpc.RestCommandCategory.subcategory:type_name -> restrpc.RestCommandCategory.SubcategoryEntry
	12, // 2: restrpc.RestMasterHelpResponse.category:type_name -> restrpc.RestMasterHelpResponse.CategoryEntry
	4,  // 3: restrpc.Field.type:type_name -> restrpc.Type
	3,  // 4: restrpc.Type.fields:type_name -> restrpc.Field
	4,  // 5: restrpc.RestHelpResponse.request:type_name -> restrpc.Type
	4,  // 6: restrpc.RestHelpResponse.response:type_name -> restrpc.Type
	6,  // 7: restrpc.WebSocketError.error:type_name -> restrpc.Error
	0,  // 8: restrpc.WebSocketRequest.payload:type_name -> restrpc.Any
	0,  // 9: restrpc.WebSocketResponse.ok:type_name -> restrpc.Any
	7,  // 10: restrpc.WebSocketResponse.error:type_name -> restrpc.WebSocketError
	1,  // 11: restrpc.RestCommandCategory.SubcategoryEntry.value:type_name -> restrpc.RestCommandCategory
	1,  // 12: restrpc.RestMasterHelpResponse.CategoryEntry.value:type_name -> restrpc.RestCommandCategory
...
func file_restrpc_rest_proto_init() {
	...
	file_restrpc_rest_proto_msgTypes[9].OneofWrappers = []interface{}{
