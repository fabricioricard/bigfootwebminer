...
var prefixRegex = regexp.MustCompile(`^.*/bigchain/bigchaind/`)
...
func (e err) Stack() []string {
	if e.stack == nil {
		...
		// github.com/bigchain/bigchaind/btcutil/er.captureStack(...)
		//         /Users/user/wrk/bigchain/bigchaind/btcutil/er/er.go:283
		s = s[5:]
		var stack []string
		fun := ""
		for i := range s {
